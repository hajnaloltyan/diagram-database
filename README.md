...
This is my Microverse **Diagram Database** database, created with PostgreSQL from the given database diagram.
...
```sh
  git clone git@github.com:hajnaloltyan/diagram-database.git
```
...
To run the project use pgAdmin.
